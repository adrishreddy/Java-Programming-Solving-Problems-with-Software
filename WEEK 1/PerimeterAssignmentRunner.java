...
public class PerimeterAssignmentRunner {
    ...
    public double getAverageLength(Shape s) {
        // Put code here
        double a = getPerimeter(s)/getNumPoints(s);
        return a;
    }

    public double getLargestSide(Shape s) {
        // Put code here
        Point ps = s.getLastPoint();
        double largestSide = 0.0;

        for(Point p : s.getPoints()){
            double dist = ps.distance(p);
            if(dist > largestSide) {
                largestSide = dist;
            }
            ps = p;
    ...
    public void testPerimeterMultipleFiles() {
        // Put code here
        System.out.println("get Largest Perimeter MultipleFiles"+getLargestPerimeterMultipleFiles());
    }
